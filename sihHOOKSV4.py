...
# CONFIGURATION
# ==========================
OPENROUTER_API_KEY = "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"  # <--- put your OpenRouter key here
client = OpenAI(
...
def save_report_docx(content, domain):
    ...
    report_file = os.path.join(report_dir, f"{domain}_report.docx")
